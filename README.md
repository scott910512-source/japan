...
탭은 넷입니다 — 켜면 바로 오늘 공부를 시작할 수 있어야 해서요.

- **홈**: 「오늘 학습 시작」 한 버튼(하던 게 있으면 이어하기), 이어서 공부하기(N3 코스 · 오늘 복습), 오늘 진행 상태, JLPT N3 준비도
- **학습**: 무엇을 공부할지 고르는 자리 — JLPT N3(「한 권으로 끝내는 N3」 코스), 콘텐츠(단어 · 문법 · 한자 · 문장 · 듣기 · 영상), 연습(단어 시험 · 동사 활용 · 부사 · 짝 맞추기 · 실전), 그 밖에(완전기초 · 독일어)
- **복습**: 오늘 복습(계획과 같은 수), 틀린 문제(N3 오답노트), 취약 단어, 취약 문법, 문장 복습, 전체 복습(회독 학습)
- **내 학습**: JLPT N3 진도·준비도, 오늘 진행, 학습 활동, 달력, 기억 수준, 취약 영역, 설정(학습 · 음성 · 계정 · 백업 · 도구 · 앱 정보)
...
`src/index.css`의 import 순서는 기존 스타일 우선순위를 보존하므로 유지하세요. 학습 규칙은 `docs/PLAN.md`의 §0-A, 구조 검토는 `docs/REFACTOR_2026-09-12.md`, 탭을 넷으로 줄인 정보구조 개편은 `docs/REFACTOR_2026-09-16.md`에 기록했습니다.
